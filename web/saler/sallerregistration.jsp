<%-- 
    ...
    Created on : 30 Jun, 2023, 1:26:35 PM
    Author     : deepa
--%>
                    ...
                    <div Style="width:100%;height: 480px ; display: inline-flex; overflow: hidden;">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <h2 style="color:#20b1c1;color:red;text-align: center">SIGN UP</h2>
                                 <h3 class="bg-danger fw-bold">
                                        <%@include file="/message.jsp" %>
                                    </h3><br>
                                <form action="/GROCRY/registration" method="post">
                                    <table style="margin-top: 30px;margin-left: 30px;color:white;margin-bottom: 10px;">
                                        <tr>
                                            <td>name</td>
                                            <td><input type="text" placeholder="Enter Username" name="name"><br></td>
                                        </tr>
                                           <tr>
                                            <td>Address</td>
                                            <td><input type="text" placeholder="Enter Address" name="address"><br></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>Phone Number</td>
                                            <td><input type="tel" placeholder="Enter phonenumber" name="uphone"><br>
                                            </td>
                                        </tr>
                                         <tr>
                                            <td>Pan Card</td>
                                            <td><input type="text" placeholder="Enter Pan Card" name="panno"><br>
                                            </td>
                                        </tr>
                                         <tr>
                                            <td>Shop type</td>
                                            <td><input type="text" placeholder="Enter shop type" name="shop_type"><br></td>
                                        </tr>
                                        <tr>
                                         <td>Enter password</td>
                                            <td><input type="password" placeholder="Enter password" name="upwd"><br></td>
                                        </tr>
                                        <tr>
                                         <td>Enter conform password</td>
                                            <td><input type="password" placeholder="Enter password again" name="cupwd"><br></td>
                                        </tr>
                                    </table>
